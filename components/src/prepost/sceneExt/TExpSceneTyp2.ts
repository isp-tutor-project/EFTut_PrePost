...
{
	public traceTExpSceneTyp2:boolean = false;
	...
	constructor()
	{
		...
		if(this.traceTExpSceneTyp2) CUtil.trace("TExpSceneTyp2:Constructor");		
...
//***** Clickable image - imgTool actions
	...
	{
		if(this.traceTExpSceneTyp2) CUtil.trace("doImgMap: " + evt.selection);
	...
	{
		if(this.traceTExpSceneTyp2) CUtil.trace(" this.doTabMap: " + evt.selection);
